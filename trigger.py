...
def analyze_triggers(df):
    ...
    # Handle if 'Close' is a DataFrame (multi-column)
    ...
    if u_curve_formed:
        ...
        # Handle if crossed is DataFrame
    ...
    if buy_trigger and buy_date in df.index:
        ...
        if len(df_post_buy) > 0:
            ...
            # Explicitly cast to bool to avoid ValueError
    ...
    return {
        ...
        # Optional: remove BUY Date if you want to avoid errors
